...
var V = CACHE_PREFIX + 'beta-0.8.1-ads-account-verified';
var ASSETS = ['./','./index.html','./m/','./m/index.html','./dashboard.html',
  './terms/','./privacy/','./account/delete/','./help/','./help/account/','./workbench/','./advertising/','./learn/','./learn/evidence-first-launch/','./learn/mobile-pwa-release/','./learn/honest-benchmarking/','./robots.txt','./sitemap.xml','./ads.txt',
  './assets/qr.js','./assets/auth.js','./assets/shell.js','./assets/legal.css','./assets/content-guide.js','./assets/content-guide.css','./assets/workbench.js','./assets/workbench.css','./assets/adsense-config.js','./assets/adsense.js','./assets/adsense.css','./assets/learn.css','./manifest.webmanifest',
  ...
  './content/content-guide-v2.json','./content/gate-guides.json','./content/glossary-v1.json','./content/help-faq-v1.json','./content/sample-cases-v1.json','./content/domain-lenses-v1.json','./content/domain-catalog-v1.json','./content/locale-en-v1.json'];
