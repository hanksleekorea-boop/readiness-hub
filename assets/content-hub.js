...
(function(){
  ...
  function render(){
    ...
    host.innerHTML='<div class="crh-hub-hero">'
      ...
      +card('↗','시장 비교','500개 도메인 카탈로그','교육·커머스·SaaS를 포함한 도메인 후보와 상위 서비스 비교 근거를 연결합니다.','500','도메인',mobile?'../workbench/#domains':'workbench/#domains',false)
      ...
      +'<a href="'+(mobile?'../workbench/#content':'workbench/#content')+'">콘텐츠 가이드</a>'
      +'<a href="'+(mobile?'../help/':'help/')+'">필수 게이트 해설</a>'
      +'<a href="'+(mobile?'../workbench/#domains':'workbench/#domains')+'">교육 렌즈</a>'
      +'<a href="'+(mobile?'../workbench/#domains':'workbench/#domains')+'">커머스 렌즈</a>'
      +'<a href="'+(mobile?'../workbench/#domains':'workbench/#domains')+'">SaaS 렌즈</a>'
